...
public class Book extends Bookmark implements Shareable{
	...
	if(getGenre().equals(BookGenre.SELF_HELP)||getGenre().equals(BookGenre.PHILOSOPHY)){
		return false;
	}else{
		return true;
	}
	...
	public String getItemData() {
		...
		builder.append("<authors>").append(StringUtils.join(authors,",")).append("<publisher");
		builder.append("<publisher>").append(publisher).append("<publisher");
		builder.append("<publicationYear>").append(publicationYear).append("<publicationYear");
		builder.append("<Genre>").append(genre).append("<Genre>");
		builder.append("<amazonRating>").append(amazonRating).append("<amazonRatings>");
		builder.append("</item>");
